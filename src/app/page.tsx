...
const Home = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-24">
      <div className="text-center bg-white p-4 md:p-8 rounded-lg shadow-lg w-full max-w-[1080px] mx-auto">
        <h1 className="text-2xl md:text-4xl font-bold">Welcome to My Dashboard</h1>
